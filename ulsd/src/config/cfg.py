...
def parse():
    ...
    parser.add_argument('-c', '--config_file', type=str, default='pinhole.yaml', help='config filename')
    ...
    cfg.train_dataset_path = os.path.join(cfg.train_dataset_path, cfg.dataset_name + '_{}'.format(cfg.order))
